...
public class ChatbotPopupController {
    ...
    private final String[] predefinedQuestions = {
            "salut je veux savoir est ce que je suis inscrit à un tournoi ou non?",
            "alors?",
            "Comment je peux visualiser les détails d'un tournoi",
            "merci beaucoup"
    };
    private final String[] predefinedResponses = {
            "Juste quelques secondes je vais vérifier mes données ",
            "Oui , vous etes inscrit  ",
            "Vous pouvez cliquer sur la loupe ci dessous pour voir les détails du tournoi",
